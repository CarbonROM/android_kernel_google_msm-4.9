...
/* max time before a read sync is submitted. */
static const int sync_read_expire	= 350;
/* max time before a write sync is submitted. */
static const int sync_write_expire	= 550;
/* ditto for read async, these limits are SOFT! */
static const int async_read_expire	= 250;
/* ditto for write async, these limits are SOFT! */
static const int async_write_expire	= 450;
/* # of sequential requests treated as one by the above parameters. */
...
SHOW_FUNCTION(maple_sync_read_expire_show,
	      mdata->fifo_expire[SYNC][READ], 1);
SHOW_FUNCTION(maple_sync_write_expire_show,
	      mdata->fifo_expire[SYNC][WRITE], 1);
SHOW_FUNCTION(maple_async_read_expire_show,
	      mdata->fifo_expire[ASYNC][READ], 1);
SHOW_FUNCTION(maple_async_write_expire_show,
	      mdata->fifo_expire[ASYNC][WRITE], 1);
SHOW_FUNCTION(maple_fifo_batch_show,
	      mdata->fifo_batch, 0);
...
STORE_FUNCTION(maple_sync_read_expire_store,
	       &mdata->fifo_expire[SYNC][READ], 0, INT_MAX, 1);
STORE_FUNCTION(maple_sync_write_expire_store,
	       &mdata->fifo_expire[SYNC][WRITE], 0, INT_MAX, 1);
STORE_FUNCTION(maple_async_read_expire_store,
	       &mdata->fifo_expire[ASYNC][READ], 0, INT_MAX, 1);
STORE_FUNCTION(maple_async_write_expire_store,
	       &mdata->fifo_expire[ASYNC][WRITE], 0, INT_MAX, 1);
STORE_FUNCTION(maple_fifo_batch_store,
